...
var (
	c2pnb176w1 elliptic2.Curve
	c2pnb163v1 elliptic2.Curve
	c2pnb163v2 elliptic2.Curve
	c2pnb163v3 elliptic2.Curve
	c2pnb208w1 elliptic2.Curve
	c2tnb191v3 elliptic2.Curve
	c2tnb191v2 elliptic2.Curve
	c2tnb191v1 elliptic2.Curve
	c2tnb239v3 elliptic2.Curve
	c2tnb239v2 elliptic2.Curve
	c2tnb239v1 elliptic2.Curve
	c2pnb272w1 elliptic2.Curve
	c2pnb304w1 elliptic2.Curve
	c2pnb368w1 elliptic2.Curve
	c2tnb359v1 elliptic2.Curve
	c2tnb431r1 elliptic2.Curve
	c2onb191v4 elliptic2.Curve
	c2onb191v5 elliptic2.Curve
	c2onb239v4 elliptic2.Curve
	c2onb239v5 elliptic2.Curve
)
...
func initAll() {
	c2pnb176w1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x6fa4539c2dadddd6bab5167d61b436e1d92bb16a562c"),
			N:       internal.HI("0x010092537397eca4f6145799d62b0a19ce06fe26ad"),
			H:       0xff6e,
		},
	)
	...
	c2pnb163v1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x01ec23211b5966adea1d3f87f7ea5848aef0b7ca9f"),
			N:       internal.HI("0x0400000000000000000001e60fc8821cc74daeafc1"),
			H:       0x2,
		},
	)
	...
	c2pnb163v2 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x079f684ddf6684c5cd258b3890021b2386dfd19fc5"),
			N:       internal.HI("0x03fffffffffffffffffffdf64de1151adbb78f10a7"),
			H:       0x2,
		},
	)
	...
	c2pnb163v3 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x5b935590c155e17ea48eb3ff3718b893df59a05d0"),
			N:       internal.HI("0x03fffffffffffffffffffe1aee140f110aff961309"),
			H:       0x2,
		},
	)
	...
	c2pnb208w1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x0f55b51a06e78e9ac38a035ff520d8b01781beb1a6bb08617de3"),
			N:       internal.HI("0x0101baf95c9723c57b6c21da2eff2d5ed588bdd5717e212f9d"),
			H:       0xfe48,
		},
	)
	...
	c2tnb191v3 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x545a39176196575d985999366e6ad34ce0a77cd7127b06be"),
			N:       internal.HI("0x155555555555555555555555610c0b196812bfb6288a3ea3"),
			H:       0x6,
		},
	)
	...
	c2tnb191v2 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x17434386626d14f3dbf01760d9213a3e1cf37aec437d668a"),
			N:       internal.HI("0x20000000000000000000000050508cb89f652824e06b8173"),
			H:       0x4,
		},
	)
	...
	c2tnb191v1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x765be73433b3f95e332932e70ea245ca2418ea0ef98018fb"),
			N:       internal.HI("0x40000000000000000000000004a20e90c39067c893bbb9a5"),
			H:       0x2,
		},
	)
	...
	c2tnb239v3 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x2e5a0eaf6e5e1305b9004dce5c0ed7fe59a35608f33837c816d80b79f461"),
			N:       internal.HI("0x0cccccccccccccccccccccccccccccac4912d2d9df903ef9888b8a0e4cff"),
			H:       0x0a,
		},
	)
	...
	c2tnb239v2 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x5667334c45aff3b5a03bad9dd75e2c71a99362567d5453f7fa6e227ec833"),
			N:       internal.HI("0x1555555555555555555555555555553c6f2885259c31e3fcdf154624522d"),
			H:       0x6,
		},
	)
	...
	c2tnb239v1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x61d8ee5077c33fecf6f1a16b268de469c3c7744ea9a971649fc7a9616305"),
			N:       internal.HI("0x2000000000000000000000000000000f4d42ffe1492a4993f1cad666e447"),
			H:       0x4,
		},
	)
	...
	c2pnb272w1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x10c7695716851eef6ba7f6872e6142fbd241b830ff5efcaceccab05e02005dde9d23"),
			N:       internal.HI("0x0100faf51354e0e39e4892df6e319c72c8161603fa45aa7b998a167b8f1e629521"),
			H:       0xff06,
		},
	)
	...
	c2pnb304w1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0xe19fbeb76e0da171517ecf401b50289bf014103288527a9b416a105e80260b549fdc1b92c03b"),
			N:       internal.HI("0x0101d556572aabac800101d556572aabac8001022d5c91dd173f8fb561da6899164443051d"),
			H:       0xfe2e,
		},
	)
	...
	c2pnb368w1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x7b3eb1bddcba62d5d8b2059b525797fc73822c59059c623a45ff3843cee8f87cd1855adaa81e2a0750b80fda2310"),
			N:       internal.HI("0x010090512da9af72b08349d98a5dd4c7b0532eca51ce03e2d10f3b7ac579bd87e909ae40a6f131e9cfce5bd967"),
			H:       0xff70,
		},
	)
	...
	c2tnb359v1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x53d7e08529547048121e9c95f3791dd804963948f34fae7bf44ea82365dc7868fe57e4ae2de211305a407104bd"),
			N:       internal.HI("0x01af286bca1af286bca1af286bca1af286bca1af286bc9fb8f6b85c556892c20a7eb964fe7719e74f490758d3b"),
			H:       0x4c,
		},
	)
	...
	c2tnb431r1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x20d0af8903a96f8d5fa2c255745d3c451b302c9346d9b7e485e7bce41f6b591f3e8f6addcbb0bc4c2f947a7de1a89b625d6a598b3760"),
			N:       internal.HI("0x0340340340340340340340340340340340340340340340340340340323c313fab50589703b5ec68d3587fec60d161cc149c1ad4a91"),
			H:       0x2760,
		},
	)
	...
	c2onb191v4 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI(""),
			N:       internal.HI("0x4000000000000000000000009CF2D6E3901DAC4C32EEC65D"),
			H:       0x2,
		},
	)
	...
	c2onb191v5 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI(""),
			N:       internal.HI("0x0FFFFFFFFFFFFFFFFFFFFFFFEEB354B7270B2992B7818627"),
			H:       0x8,
		},
	)
	...
	c2onb239v4 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI(""),
			N:       internal.HI("0x200000000000000000000000000000474F7E69F42FE430931D0B455AAE8B"),
			H:       0x04,
		},
	)
	...
	c2onb239v5 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI(""),
			N:       internal.HI("0x1555555555555555555555555555558CF77A5D0589D2A9340D963B7AD703"),
			H:       0x06,
		},
	)
}
