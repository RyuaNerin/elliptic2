...
func (*Curve) CurveType() elliptic2.CurveType        { return elliptic2.CurveTypeTwistedEdwards }
func (c *Curve) Generator() (x, y *big.Int, ok bool) { return c.Gx, c.Gy, c.withGenerator }
func (*Curve) IsInfinity(x, y *big.Int) bool         { return x.Sign() == 0 && y.Cmp(field.One) == 0 }

func (*Curve) InfinityPoint() (x, y *big.Int)   { return new(big.Int), new(big.Int).SetInt64(1) }
