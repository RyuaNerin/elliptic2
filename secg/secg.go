...
func Sect113r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect113r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect113r2() elliptic2.Curve {
	initonce.Do(initAll)
	return sect113r2
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect131r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect131r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect131r2() elliptic2.Curve {
	initonce.Do(initAll)
	return sect131r2
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect163k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect163k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect163r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect163r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect163r2() elliptic2.Curve {
	initonce.Do(initAll)
	return sect163r2
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect193r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect193r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect193r2() elliptic2.Curve {
	initonce.Do(initAll)
	return sect193r2
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect233k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect233k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect233r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect233r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect239k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect239k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect283k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect283k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect283r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect283r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect409k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect409k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect409r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect409r1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect571k1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect571k1
}
...
//
// The cryptographic operations are implemented using constant-time algorithms.
func Sect571r1() elliptic2.Curve {
	initonce.Do(initAll)
	return sect571r1
}
