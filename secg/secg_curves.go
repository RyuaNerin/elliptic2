...
var (
	sect113r1 elliptic2.Curve
	sect113r2 elliptic2.Curve
	sect131r1 elliptic2.Curve
	sect131r2 elliptic2.Curve
	sect163k1 elliptic2.Curve
	sect163r1 elliptic2.Curve
	sect163r2 elliptic2.Curve
	sect193r1 elliptic2.Curve
	sect193r2 elliptic2.Curve
	sect233k1 elliptic2.Curve
	sect233r1 elliptic2.Curve
	sect239k1 elliptic2.Curve
	sect283k1 elliptic2.Curve
	sect283r1 elliptic2.Curve
	sect409k1 elliptic2.Curve
	sect409r1 elliptic2.Curve
	sect571k1 elliptic2.Curve
	sect571r1 elliptic2.Curve
)
...
func initAll() {
	sect113r1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x00a52830277958ee84d1315ed31886"),
			N:       internal.HI("0x0100000000000000d9ccec8a39e56f"),
			H:       0x2,
		},
	)
	...
	sect113r2 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x00b3adc94ed1fe674c06e695baba1d"),
			N:       internal.HI("0x010000000000000108789b2496af93"),
			H:       0x2,
		},
	)
	...
	sect131r1 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x078c6e7ea38c001f73c8134b1b4ef9e150"),
			N:       internal.HI("0x0400000000000000023123953a9464b54d"),
			H:       0x2,
		},
	)
	...
	sect131r2 = elliptic2.NewCurve(
		&elliptic2.CurveParams{
			...
			Gy:      internal.HI("0x0648f06d867940a5366d9e265de9eb240f"),
			N:       internal.HI("0x0400000000000000016954a233049ba98f"),
			H:       0x2,
		},
	)
